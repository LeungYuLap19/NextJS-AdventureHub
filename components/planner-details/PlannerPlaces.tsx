...
export default function PlannerPlaces({ planner, selectedFsqId }: { planner: PlannersItem; selectedFsqId?: string }) {
      ...
      <div className='flex flex-col w-full gap-4'>
        {
          ...
          plannerPlaces.places.map((plannerPlace: PlannerPlace) => (
            <PlacesItem key={plannerPlace.place.fsq_id} item={plannerPlace.place} pid={planner.pid} selectedFsqId={selectedFsqId} />
          ))
        }
      </div>
    </div>
