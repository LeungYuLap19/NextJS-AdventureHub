  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: "h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-customBlack-100 [&:has([aria-selected])]:bg-customBlack-100 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
        day: cn(
        ...
        day_selected:
          ...
          'bg-customBlack-300 text-customWhite-200 hover:bg-customBlack-300 hover:text-customWhite-200 focus:bg-customBlack-300 focus:text-customWhite-200',
        day_today: 
        ...
        day_range_middle:
          ...
          'aria-selected:bg-customBlack-100',
